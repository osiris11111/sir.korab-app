  ...
  return (
    <>
      ...
      <div className="bg-surface text-on-surface font-body overflow-hidden relative">
        ...
        {/* Hero Section */}
        <section className={`relative min-h-[100svh] w-full flex flex-col items-center justify-start ${currentUser ? 'pt-0 md:pt-12' : 'pt-16 md:pt-24'} pb-12 overflow-hidden`}>
          {/* Background Video */}
          <VideoBackground />
          ...
          <div className="relative z-20 container mx-auto px-4 md:px-12 flex flex-col items-center text-center mt-0 md:mt-4">
            ...
            <motion.p 
              ...
              animate="visible"
              variants={fadeIn}
              className={`text-white font-bold max-w-3xl font-body leading-relaxed ${currentUser ? 'text-xl md:text-[1.75rem] mb-24 md:mb-32' : 'text-lg md:text-2xl mb-14'}`}
            >
            ...
            >
              ...
              <Link to={userData?.isPaid ? "/dashboard" : "/pricing"} className="w-full sm:w-auto group">
                <button className="w-full liquid-glass border border-outline-variant/40 text-white px-12 py-6 rounded-2xl font-headline font-bold tracking-[0.15em] text-lg uppercase flex items-center justify-center gap-3 hover:bg-white/10 hover:border-outline-variant transition-all duration-300">
